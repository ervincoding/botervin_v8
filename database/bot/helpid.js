const helpid = (prefix, botname, ownername, codename, arts, tz) => {
	return `☞ MENU ${botname} ☜
...
☞ *C-RANDOM* [ 22 ]
${tz} *${prefix}csadboy* <@tag>
${tz} *${prefix}cpakboy* <@tag>
${tz} *${prefix}cbaik* <@tag>
${tz} *${prefix}cjago* <@tag>
${tz} *${prefix}cjelek* <@tag>
${tz} *${prefix}ccantik* <@tag>
${tz} *${prefix}cpinter* <@tag>
${tz} *${prefix}cbeban* <@tag>
${tz} *${prefix}ckontol* <@tag>
${tz} *${prefix}chebat* <@tag>
${tz} *${prefix}cwibu* <@tag>
${tz} *${prefix}charam* <@tag>
${tz} *${prefix}cbabi* <@tag>
${tz} *${prefix}cbego* <@tag>
${tz} *${prefix}cganteng* <@tag>
${tz} *${prefix}canjing* <@tag>
${tz} *${prefix}cmonyet* <@tag>
${tz} *${prefix}csadgirl* <@tag>
${tz} *${prefix}cpakgirl* <@tag>
${tz} *${prefix}cjahat* <@tag>
${tz} *${prefix}cnolep* <@tag>
${tz} *${prefix}cgoblok* <@tag>
